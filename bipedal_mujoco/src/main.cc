...
int main(int argc, char** argv) {
  ...
  // ROS initialization
  ros::init(argc, argv, "bipedal_mujoco");
  ros::NodeHandle nh;
  ...
  // start bipedal hw loop
  using namespace ocs2::bipedal_robot;

  std::shared_ptr<BipedalMujocoHW> bipedal_hw = std::make_shared<BipedalMujocoHW>(m, d, *sim);
