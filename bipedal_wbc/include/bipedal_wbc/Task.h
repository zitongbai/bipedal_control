 ...
 * @brief A class used to construct equality and inequality constraints for 
...
class Task {
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW // This macro is used to ensure that the class has an aligned new operator
