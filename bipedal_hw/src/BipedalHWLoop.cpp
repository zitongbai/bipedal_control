...
BipedalHWLoop::BipedalHWLoop(ros::NodeHandle& nh, std::shared_ptr<BipedalHW> hardware_interface)
  ...
  loopThread_ = std::thread([&]() {
    ...
    ROS_INFO("[BipedalHWLoop] Exiting loop thread");
  });
