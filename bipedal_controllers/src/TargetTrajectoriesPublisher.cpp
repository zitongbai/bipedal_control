/**
 * @file TargetTrajectoriesPublisher.cpp
...
#include "bipedal_controllers/TargetTrajectoriesPublisher.h"
...
int main(int argc, char** argv) {
  ...
  ros::init(argc, argv, robotName + "_target_trajectories_publisher");
  ros::NodeHandle nh;
